  ...
  return (
    <div className="print:hidden">
      <div className="mb-1 flex items-center justify-between">
        ...
        {gespeichert && <span className="text-xs text-green-600 dark:text-green-400">✓ gespeichert</span>}
      </div>
      <textarea
        value={text}
        ...
        rows={zeilen}
        className="w-full rounded-lg border border-slate-300 bg-amber-50/40 p-3 text-[15px] focus:border-sky-500 focus:outline-none dark:border-slate-700 dark:bg-amber-950/20 dark:text-slate-200"
      />
    </div>
  )
}

...
export default function Stufe2() {
  ...
  return (
    <Layout titel="Stufe 2 · Themen-Training">
      <p className="-mt-2 mb-2 text-slate-600 dark:text-slate-300">
        Aufgaben nach Themen sortiert – wähle ein Thema und leg los.
      </p>
      <p className="mb-5 text-xs text-slate-500 dark:text-slate-400">
        <span className="mr-1 rounded-full bg-blue-100 px-2 py-0.5 font-medium text-blue-800 dark:bg-blue-950/40 dark:text-blue-300">Aufgabensammlung N</span>
        Aufgabe aus einer kompletten Sammlung ·{' '}
        <span className="mx-1 rounded-full bg-teal-100 px-2 py-0.5 font-medium text-teal-800 dark:bg-teal-950/40 dark:text-teal-300">Variante</span>
        abgewandelte Aufgabe ·{' '}
        <span className="mx-1 rounded-full bg-slate-200 px-2 py-0.5 font-medium text-slate-700 dark:bg-slate-700 dark:text-slate-300">Training</span>
            ...
            <button
              ...
              className={`min-h-12 shrink-0 rounded-xl border-2 px-4 text-sm font-semibold transition ${
                nurOffene
                  ...
                  : 'border-slate-300 bg-white text-slate-600 hover:border-slate-400 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-slate-500'
              }`}
            >
